<div class="scrollbar side-menu-bg" style="overflow: scroll">
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <!-- academic years-->
        <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#academicyears-menu">
                <div class="pull-left"><i class="fas fa-school"></i><span class="right-nav-text">السنوات الدراسية</span>
                </div>
                <div class="pull-right"><i class="ti-plus"></i></div>
                <div class="clearfix"></div>
            </a>
            <ul id="academicyears-menu" class="collapse" data-parent="#sidebarnav">
        ...
        <!-- generel-->
        <li>
            <a href="{{ route('generel') }}"><i class="fas fa-cogs"></i><span class="right-nav-text">تصفح
                </span></a>
        </li>
