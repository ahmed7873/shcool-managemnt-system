...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 no-print">
            <a href="{{ route('section_marks_appreciation3_report') }}" class="btn btn-secondary back_btn">
                ...
                <div class="table-responsive">
                    <table class="table-custom" id="marksTable">
                        <thead>
                            ...
                            <tr>
                                @foreach ($examsBySubject as $subjectId => $subjectExams)
                                    <th colspan="4">{{ $subjectExams->first()->subject->hours ?? 0 }} الوحدات
                                        الدراسية</th>
                                @endforeach
                            ...
                            @foreach ($students as $index => $student)
                                ...
                                <tr>
                                    ...
                                    @php
                                        $semester_gpa =
                                            $student_total_hours > 0
                                                ? $student_total_rate_x_hours / $student_total_hours
                                                : 0;
