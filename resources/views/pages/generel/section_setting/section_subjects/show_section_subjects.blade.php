...
<div class="title mb-3">
    <div style="display: flex; justify-content: space-between;">
        ...
        <a class="mx-2" style="font-size: 14px; text-decoration: underline"
            href="{{ route('show_sections', session()->get('term')) }}">الرجوع للاقسام</a>
    </div>
</div>
<!-- breadcrumb -->
@section('PageTitle')
    ...
    <div class="col-xl-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                @endif
                <a href="{{ route('get_term_subjects') }}" class="btn btn-success m-3">جلب مواد</a>
                <form action="{{ route('unreleatoin_term_subjects') }}" method="post">
                    @csrf
